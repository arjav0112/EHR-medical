...
export default function AuthModal({ onClose, initialMode = 'login', redirectTo = '/dashboard' }: AuthModalProps) {
  ...
  return (
    ...
    >
      {/* Card */}
      <div
        className="relative w-full max-w-[400px] bg-white rounded-3xl border border-gray-100 shadow-[0_8px_60px_rgba(0,0,0,0.20)] p-8 animate-in fade-in slide-in-from-bottom-4 duration-300"
      ...
      >
        ...
        {/* Heading */}
        <h2 className="text-[26px] font-bold text-gray-900 leading-tight mb-1">
